window.CIVIL_LAW_2021 = {
  id: "realtor-2021-32-b-civil-law",
  title: "2021년 제32회 민법 및 민사특별법",
  ...
  source: {
    question: "./public/pdfs/2021-question.pdf",
    answer: "./public/pdfs/2021-answer.pdf",
  },
  questions: [
    {
      number: 41,
      topic: "법률행위 - 단독행위",
      prompt: "상대방 있는 단독행위에 해당하지 않는 것은?(다툼이 있으면 판례에 따름)",
      choices: [
        "공유지분의 포기",
        "무권대리행위의 추인",
        "상계의 의사표시",
    ...
    },
    {
      number: 42,
      topic: "대리 - 무권대리",
      prompt: "행위능력자 乙은 대리권 없이 甲을 대리하여 甲이 보유하고 있던 매수인의 지위를 丙에게 양도하기로 약정하고, 이에 丙은 乙에게 계약금을 지급하였다. 乙은 그 계약금을 유흥비로 탕진하였다. 이에 관한 설명으로 틀린 것은?(단, 표현대리는 성립하지 않으며, 다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 43,
      topic: "대리 - 복대리",
      prompt: "甲은 자기 소유 X토지를 매도하기 위해 乙에게 대리권을 수여하였다. 이후 乙은 丙을 복대리인으로 선임하였고, 丙은 甲을 대리하여 X토지를 매도하였다. 이에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 44,
      topic: "법률행위 - 의사표시",
      prompt: "의사와 표시가 불일치하는 경우에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 47,
      topic: "법률행위 - 취소",
      prompt: "법률행위의 취소에 관한 설명으로 틀린 것은?",
      choices: [
    ...
    },
    {
      number: 48,
      topic: "대리 - 표현대리",
      prompt: "표현대리에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
        "본인이 타인에게 대리권을 수여하지 않았지만 수여하였다고 상대방에게 통보한 경우, 그 타인이 통보받은 상대방 외의 자와 본인을 대리하여 행위를 한 때에는 민법 제125조의 표현대리가 적용된다.",
    ...
    },
    {
      number: 49,
      topic: "법률행위 - 무효",
      prompt: "법률행위의 무효에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 50,
      topic: "법률행위 - 조건과 기한",
      prompt: "법률행위의 조건과 기한에 관한 설명으로 틀린 것은?",
      choices: [
    ...
    },
    {
      number: 51,
      topic: "물권법 - 물권 일반",
      prompt: "물권에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 54,
      topic: "물권법 - 가등기",
      prompt: "청구권보전을 위한 가등기에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 55,
      topic: "물권법 - 소유권",
      prompt: "소유권에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 56,
      topic: "물권법 - 공유",
      prompt: "甲, 乙, 丙은 X토지를 각 1/2, 1/4, 1/4의 지분으로 공유하고 있다. 이에 관한 설명으로 옳은 것은?(단, 구분소유적 공유관계는 아니며, 다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 58,
      topic: "물권법 - 점유권",
      prompt: "점유권에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 63,
      topic: "물권법 - 저당권",
      prompt: "저당권의 효력이 미치는 목적물의 범위에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 66,
      topic: "계약법 - 합의해제",
      prompt: "합의해제에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 68,
      topic: "계약법 - 청약",
      prompt: "청약에 관한 설명으로 옳은 것은?(단, 특별한 사정은 없으며, 다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 69,
      topic: "계약법 - 약관",
      prompt: "약관에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 70,
      topic: "계약법 - 환매",
      prompt: "甲은 자기 소유 X토지를 3억원에 乙에게 매도하면서 동시에 환매할 권리를 보유하기로 약정하고 乙이 X토지에 대한 소유권 이전등기를 마쳤다. 이에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 71,
      topic: "계약법 - 매도인의 담보책임",
      prompt: "수량을 지정한 매매의 목적물의 일부가 멸실된 경우 매도인의 담보책임에 관한 설명으로 틀린 것은?(단, 이에 관한 특약은 없으며, 다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 73,
      topic: "계약법 - 임대차",
      prompt: "乙이 甲으로부터 건물의 소유를 목적으로 X토지를 10년간 임차하여 그 위에 자신의 건물을 신축한 경우에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 74,
      topic: "계약법 - 전대차",
      prompt: "甲은 자기 소유 X창고건물 전부를 乙에게 월차임 60만원에 3년간 임대하였고, 乙은 甲의 동의를 얻어 X건물 전부를 丙에게 월차임 70만원에 2년간 전대하였다. 이에 관한 설명으로 틀린 것은?(단, 이에 관한 특약은 없으며, 다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      ...
      prompt: "주택임대차보호법상의 대항력에 관한 설명으로 틀린 것은?(단, 일시사용을 위한 임대차가 아니고 임차권등기가 이루어지지 아니한 경우를 전제하며 다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 78,
      topic: "민사특별법 - 가등기담보법",
      prompt: "가등기담보등에 관한 법률에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 79,
      topic: "민사특별법 - 부동산실명법",
      prompt: "甲은 법령상의 제한을 피하여 乙 소유의 X부동산을 매수하고자 자신의 친구 丙과 X부동산의 매수에 관한 명의신탁약정을 체결하였다. 그에 따라 2021년 5월 丙은 乙과 X부동산 매매계약을 체결하고, 甲의 자금으로 그 대금을 지급하여 丙 명의로 등기 이전을 마쳤다. 이에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
