window.CIVIL_LAW_2015 = {
  "id": "realtor-2015-26-a-civil-law",
  "title": "2015년 제26회 민법 및 민사특별법",
  ...
  "source": {
    "question": "https://www.q-net.or.kr/cst003.do?artlSeq=5153804&boardId=Q004&gId=08&gSite=L&id=cst00302&menuType=cst00309",
    "answer": "https://www.q-net.or.kr/cst003.do?artlSeq=5162623&boardId=Q004&gId=08&gSite=L&id=cst00302&menuType=cst00310"
  },
  "questions": [
    {
      "number": 41,
      "topic": "의사표시 - 통정허위표시",
      "prompt": "통정허위표시의 무효는 선의의 ‘제3자’에게 대항하지 못한다는 규정의 ‘제3자’에 해당하는 자를 모두 고른 것은?(다툼이 있으면 판례에 따름)\nㄱ. 통정허위표시에 의한 채권을 가압류한 자\nㄴ. 통정허위표시에 의해 설정된 전세권에 대해 저당권을 설정 받은 자\nㄷ. 대리인의 통정허위표시에서 본인\nㄹ. 통정허위표시에 의해 체결된 제3자를 위한 계약에서 제3자",
      "choices": [
        "ㄱ, ㄴ",
        "ㄱ, ㄷ",
        "ㄴ, ㄷ",
    ...
    },
    {
      "number": 42,
      "topic": "법률행위 - 준법률행위",
      "prompt": "준법률행위인 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
        "법정대리인의 동의",
        "착오에 의한 의사표시의 취소",
        "채무이행의 최고",
    ...
    },
    {
      "number": 45,
      "topic": "대리 - 무권대리",
      "prompt": "무권대리에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 46,
      "topic": "법률행위 - 이중매매",
      "prompt": "甲은 자신의 X토지를 乙에게 매도하고 중도금을 수령한 후, 다시 丙에게 매도하고 소유권이전등기까지 경료해 주었다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 48,
      "topic": "법률행위 - 미성년자 취소",
      "prompt": "미성년자 甲은 법정대리인 丙의 동의 없이 자신의 토지를 甲이 미성년자임을 안 乙에게 매도하고 대금수령과 동시에 소유권이전등기를 해주었는데, 丙이 甲의 미성년을 이유로 계약을 적법하게 취소하였다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
        "계약은 소급적으로 무효가 된다.",
        "甲이 미성년자임을 乙이 몰랐더라도 丙은 계약을 취소할 수 있다.",
        "甲과 乙의 반환의무는 서로 동시이행관계에 있다.",
        "甲이 대금을 모두 생활비로 사용한 경우 대금 전액을 반환하여야 한다.",
        "만약 乙이 선의의 丁에게 매도하고 이전등기 하였다면, 丙이 취소하였더라도 丁은 소유권을 취득한다."
      ],
      "answers": [
        5
      ]
    },
    {
      "number": 49,
      "topic": "의사표시 - 착오",
      "prompt": "착오에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 50,
      "topic": "물권 - 지상권",
      "prompt": "乙은 甲의 X토지에 건물을 소유하기 위하여 지상권을 설정받았다. 다음 설명 중 옳은 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 51,
      "topic": "물권 - 분묘기지권",
      "prompt": "제사주재자인 장남 甲은 1985년 乙의 토지에 허락 없이 부친의 묘를 봉분 형태로 설치한 이래 2015년 현재까지 평온·공연하게 분묘의 기지(基地)를 점유하여 분묘의 수호와 봉사를 계속하고 있다. 다음 설명 중 옳은 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 54,
      "topic": "물권변동 - 미등기 건물",
      "prompt": "乙은 丙의 토지 위에 있는 甲소유의 X건물을 매수하여 대금완납 후 그 건물을 인도받고 등기서류를 교부받았지만, 아직 이전등기를 마치지 않았다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 55,
      "topic": "물권변동 - 등기",
      "prompt": "등기에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      ...
      "choices": [
        ...
        "점유자의 점유권원에 관한 주장이 인정되지 않는다는 것만으로도 자주점유의 추정이 깨진다.",
    ...
    },
    {
      "number": 58,
      "topic": "물권 - 취득시효",
      "prompt": "시효취득을 할 수 없는 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
        "저당권",
        "계속되고 표현된 지역권",
        "지상권",
    ...
    },
    {
      "number": 59,
      "topic": "물권 - 공유",
      "prompt": "X토지를 甲이 2/3지분, 乙이 1/3지분으로 등기하여 공유하면서 그 관리방법에 관해 별도로 협의하지 않았다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 62,
      "topic": "물권 - 유치권",
      "prompt": "유치권에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 65,
      "topic": "계약법 - 청약과 승낙",
      "prompt": "계약의 청약과 승낙에 관한 설명으로 옳은 것은?",
      "choices": [
    ...
    },
    {
      "number": 67,
      "topic": "계약법 - 동시이행항변권",
      "prompt": "동시이행의 항변권에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      ...
      "prompt": "甲은 자신의 토지를 乙에게 매도하면서 그 대금은 乙이 甲의 의무이행과 동시에 丙에게 지급하기로 약정하고, 丙은 乙에게 수익의 의사표시를 하였다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 69,
      "topic": "계약법 - 해제",
      "prompt": "계약의 해제에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 72,
      "topic": "계약법 - 임대차",
      "prompt": "임차인의 권리에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 74,
      "topic": "계약법 - 매도인 담보책임",
      "prompt": "매도인의 담보책임에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 75,
      "topic": "민사특별법 - 주택임대차",
      "prompt": "주택임대차보호법에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 76,
      "topic": "민사특별법 - 집합건물",
      "prompt": "집합건물의 소유 및 관리에 관한 법령상 집합건물에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 77,
      "topic": "민사특별법 - 가등기담보",
      "prompt": "가등기담보 등에 관한 법률에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 78,
      "topic": "민사특별법 - 명의신탁",
      "prompt": "2015년 甲은 丙의 X토지를 취득하고자 친구 乙과 명의신탁약정을 체결하고 乙에게 그 매수자금을 주었다. 甲과의 약정대로 乙은 명의신탁 사실을 모르는 丙으로부터 X토지를 매수하는 계약을 자기 명의로 체결하고 소유권이전등기를 경료 받았다. 다음 설명 중 옳은 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
        "X토지의 소유자는 丙이다.",
    ...
    },
    {
      "number": 79,
      "topic": "민사특별법 - 부동산실명법",
      "prompt": "부동산 실권리자명의 등기에 관한 법률에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      "choices": [
    ...
    },
    {
      "number": 80,
      "topic": "민사특별법 - 상가임대차",
      "prompt": "상가건물 임대차보호법상 임차인이 그가 주선한 신규 임차인이 되려는 자로부터 권리금을 지급받는 것을 방해한 임대인에게 손해배상을 청구할 권리는 “임대차가 종료한 날부터 ( ) 이내에 행사하지 않으면 시효의 완성으로 소멸한다.” 빈 칸에 들어갈 기간은?",
      "choices": [
        "6개월",
        "1년",
        "2년",
