window.CIVIL_LAW_2025 = {
  id: "realtor-2025-36-a-civil-law",
  title: "2025년 제36회 민법 및 민사특별법",
  ...
  source: {
    question: "https://www.q-net.or.kr/cst003.do?artlSeq=5247125&boardId=Q004&gId=08&gSite=L&id=cst00302&menuType=cst00309",
    answer: "https://www.q-net.or.kr/cst003.do?artlSeq=5249925&boardId=Q004&gId=08&gSite=L&id=cst00302&menuType=cst00310",
  },
  questions: [
    {
      number: 41,
      topic: "법률행위 - 반사회질서",
      prompt: "반사회질서의 법률행위에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 42,
      topic: "의사표시 - 통정허위표시",
      prompt: "통정허위표시를 기초로 새로운 법률상 이해관계를 맺은 제3자에 해당하는 자를 모두 고른 것은?(다툼이 있으면 판례에 따름)\nㄱ. 가장채권을 가압류한 자\nㄴ. 파산선고를 받은 가장채권자의 파산관재인\nㄷ. 가장소비대차의 계약상 지위를 이전받은 자",
    ...
    },
    {
      number: 43,
      topic: "대리 - 무권대리",
      prompt: "무권대리인 乙이 甲을 대리하여 매수인 丙과 매매계약을 체결하였고, 당시 丙은 乙이 무권대리인이라는 사실에 대해 선의ㆍ무과실이었다. 이에 관한 설명으로 틀린 것은?(표현대리는 고려하지 않고, 다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 46,
      topic: "의사표시 - 착오",
      prompt: "착오로 인한 의사표시에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      ...
      choices: [
        "궁박에는 경제적인 궁박뿐만 아니라 정신적ㆍ심리적 궁박도 포함된다.",
        "무경험은 거래일반에 대한 경험부족이 아니라 해당 법률행위가 속한 특정영역에서의 경험부족을 뜻한다.",
        "급부와 반대급부 사이의 현저한 불균형은 구체적ㆍ개별적 사안에서 일반인의 사회통념에 따라 결정된다.",
    ...
    },
    {
      number: 48,
      topic: "법률행위 - 조건과 기한",
      prompt: "법률행위의 부관에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 52,
      topic: "물권법 - 물권법정주의",
      prompt: "민법상 물권에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
        ...
        "전세권자가 사용ㆍ수익의 권능을 완전히 배제하고 채권담보만을 위하여 전세권을 설정받는 것은 물권법정주의에 반한다.",
    ...
    },
    {
      number: 53,
      topic: "물권법 - 점유권능",
      prompt: "권리의 객체가 토지인 경우, 그 토지를 점유할 권리가 인정되지 않는 물권을 모두 고른 것은?\nㄱ. 저당권\nㄴ. 전세권\nㄷ. 지상권",
      choices: ["ㄱ", "ㄷ", "ㄱ, ㄴ", "ㄴ, ㄷ", "ㄱ, ㄴ, ㄷ"],
      answers: [1],
    },
    {
      number: 54,
      topic: "물권법 - 합유",
      prompt: "민법상 합유에 관한 설명으로 틀린 것은?(특별한 사정이 없으며, 다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 55,
      topic: "물권법 - 점유취득시효",
      prompt: "甲 소유의 X토지를 乙이 20년 이상 소유의 의사로 평온, 공연하게 현재까지 점유하고 있다. 乙은 甲에게 취득시효 완성을 이유로 X토지의 소유권이전등기를 청구하였지만, 아직 등기는 이전받지 못하였다. 이후 발생한 아래 각 상황에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
        "丙이 X토지 위에 비닐하우스를 설치한 경우, 乙은 丙에게 점유권에 기한 방해배제를 청구할 수 있다.",
    ...
    },
    {
      number: 56,
      topic: "물권법 - 공유",
      prompt: "甲, 乙, 丙이 각각 4/7, 2/7, 1/7의 지분비율로 X토지를 공유하는 경우에 관한 설명으로 틀린 것은?(별도의 특약은 없고, 다툼이 있으면 판례에 따름)",
      choices: [
        "甲은 乙, 丙과의 협의 없이 X토지의 관리에 관한 사항을 정할 수 있다.",
        "甲은 乙, 丙의 동의 없이 X토지를 처분하지 못한다.",
        "丙은 甲, 乙의 동의 없이 자신의 지분을 제3자에게 담보로 제공할 수 있다.",
        "乙이 甲, 丙과의 협의 없이 X토지의 전부를 독점적으로 점유ㆍ사용하고 있는 경우, 丙은 공유물의 보존행위로 자신에게 X토지를 인도할 것을 청구할 수 있다.",
    ...
    },
    {
      number: 57,
      topic: "물권법 - 물권변동",
      prompt: "등기 없이도 물권변동의 효력이 생기는 사유가 아닌 것은?(다툼이 있으면 판례에 따름)",
      choices: ["상속", "재결수용", "이행판결", "건물의 신축", "국세징수법상 공매"],
      answers: [3],
    },
    {
      number: 58,
      topic: "물권법 - 전세권",
      prompt: "甲이 乙로부터 乙 소유의 X건물에 대하여 전세권을 설정받은 경우에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 59,
      topic: "물권법 - 지상권",
      prompt: "지상권에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 61,
      topic: "물권법 - 법정지상권",
      prompt: "관습법상 법정지상권에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 63,
      topic: "물권법 - 물상대위",
      prompt: "저당권에 관하여 (  )에 들어갈 권리로 옳은 것은?\n저당권자는 저당부동산의 멸실, 훼손 또는 공용징수로 인하여 저당권설정자가 받을 금전 기타 물건에 대하여 (  )을 가진다.",
      choices: ["비용상환청구권", "물상대위권", "매수청구권", "해제권", "갱신청구권"],
      answers: [2],
    },
    {
      number: 64,
      topic: "물권법 - 유치권",
      prompt: "민법상 유치권에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 66,
      topic: "계약법 - 계약의 성립",
      prompt: "계약의 성립에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 68,
      topic: "계약법 - 합의해제",
      prompt: "부동산 매매계약이 합의해제된 경우에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 70,
      topic: "계약법 - 매도인 담보책임",
      prompt: "민법상 매도인의 담보책임에 관한 설명으로 옳은 것은?",
      choices: [
    ...
    },
    {
      number: 74,
      topic: "계약법 - 계약의 유형",
      prompt: "민법상 계약의 유형과 성질에 관한 설명으로 옳은 것은?(특약은 고려하지 않음)",
      choices: [
        "매매계약은 요물계약이다.",
        "매매계약은 낙성계약이다.",
        "교환계약은 요식계약이다.",
    ...
    },
    {
      number: 76,
      topic: "민사특별법 - 집합건물법",
      prompt: "집합건물의 소유 및 관리에 관한 법률에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 77,
      topic: "민사특별법 - 가등기담보법",
      prompt: "甲은 2024. 5. 1. 乙에게 1억 원을 변제기는 1년 후, 이자는 연 5%로 정하여 대여하면서 그 대여금채권과 乙에 대한 물품대금채권 1억 원을 담보하기 위해 가등기담보계약을 체결하고, 이를 위해 乙 소유의 X토지(계약 당시 시가 2억 원)에 甲 명의로 가등기를 마쳤다. 그 후 乙은 변제기가 지난 2025. 5. 7. 양 채권 중 물품대금채무만 甲에게 전액 변제하였다. 이에 관한 설명으로 옳은 것을 모두 고른 것은?(다툼이 있으면 판례에 따름)\nㄱ. 甲과 乙의 가등기담보계약에는 가등기담보 등에 관한 법률이 적용된다.\nㄴ. 甲이 청산절차를 거쳐 X토지에 관하여 소유권이전의 본등기를 마친 경우, 본등기를 위해 지출한 절차비용은 청산금에서 공제할 수 없다.\nㄷ. 甲이 청산절차를 거치지 않고 X토지에 관하여 2025. 6. 15. 본등기를 마친 다음, 선의의 丙에게 2025. 8. 1. 소유권이전등기를 마친 경우, 2025. 8. 1.부터 甲 명의의 본등기도 확정적으로 유효해진다.",
      choices: ["ㄱ", "ㄷ", "ㄱ, ㄴ", "ㄴ, ㄷ", "ㄱ, ㄴ, ㄷ"],
      answers: [3],
    },
    {
      number: 78,
      topic: "민사특별법 - 부동산실명법",
      prompt: "甲은 2022. 7. 1. 자신의 X토지에 관하여 乙과 유효한 명의신탁약정을 체결하고, 乙 명의로 소유권이전등기를 마쳤다. 이에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
        "甲과 乙이 부부인 경우, 甲이 사망하더라도 그 명의신탁약정은 甲의 상속인 丙과 乙 사이에 유효하게 존속한다.",
        "甲이 丙에게 X토지를 매도한 경우, 그 매매계약은 민법 제569조의 타인 권리의 매매라고 할 수 없다.",
        "丙이 X토지를 무단점유하여 사용ㆍ수익할 경우, 甲은 丙에게 직접 그 소유권을 주장할 수 없다.",
    ...
    },
    {
      number: 79,
      topic: "민사특별법 - 부동산실명법",
      prompt: "甲이 그 소유의 X토지에 관하여 2025. 5. 3. 친구 乙과의 명의신탁약정에 따라 乙 명의로 소유권이전등기를 마쳤다. 이에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    {
      number: 80,
      topic: "민사특별법 - 상가임대차보호법",
      prompt: "甲은 상품판매를 위해 2025. 5. 1. 乙로부터 부산광역시 소재 乙 소유의 X상가를 보증금 6억 원, 월 차임 100만 원에 임차하는 계약을 체결하였다. 계약 당일 甲은 乙에게 보증금을 지급하고 X상가를 인도받아 사업자등록과 확정일자까지 마쳤다. 위 계약에 적용되는 상가건물 임대차보호법상의 규정에 해당하는 것을 모두 고른 것은?(다툼이 있으면 판례에 따름)\nㄱ. 임차인의 보증금에 대한 우선변제권에 관한 규정\nㄴ. 임차인의 임차권등기명령에 관한 규정\nㄷ. 차임연체에 따른 임대인의 해지권에 관한 규정",
      choices: ["ㄱ", "ㄷ", "ㄱ, ㄴ", "ㄴ, ㄷ", "ㄱ, ㄴ, ㄷ"],
      answers: [2],
    },
  ],
