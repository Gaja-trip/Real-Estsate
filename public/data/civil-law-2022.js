window.CIVIL_LAW_2022 = {
  id: "realtor-2022-33-a-civil-law",
  title: "2022년 제33회 민법 및 민사특별법",
  ...
  source: {
    question: "https://www.q-net.or.kr/cst003.do?artlSeq=5211107&boardId=Q004&gId=08&gSite=L&id=cst00302&menuType=cst00309",
    answer: "https://www.q-net.or.kr/cst003.do?artlSeq=5211208&boardId=Q004&gId=08&gSite=L&id=cst00302&menuType=cst00310",
  },
  questions: [
    {
      number: 41,
      topic: "법률행위 - 단독행위",
      prompt: "상대방 없는 단독행위에 해당하는 것은?",
      choices: [
        "착오로 인한 계약의 취소",
    ...
    },
    {
      number: 42,
      topic: "법률행위 - 무효",
      prompt: "다음 중 무효인 법률행위는?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 43,
      topic: "법률행위 - 통정허위표시",
      prompt: "통정허위표시(민법 제108조)에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 45,
      topic: "법률행위 - 취소",
      prompt: "법률행위의 취소에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 46,
      topic: "법률행위 - 조건",
      prompt: "조건에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 47,
      topic: "대리 - 대리권",
      prompt: "甲은 그 소유의 X건물을 매도하기 위하여 乙에게 대리권을 수여하였다. 이에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 48,
      topic: "대리 - 일반",
      prompt: "민법상 대리에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 49,
      topic: "대리 - 표현대리",
      prompt: "권한을 넘은 표현대리에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 50,
      topic: "대리 - 무권대리",
      prompt: "대리권 없는 甲은 乙 소유의 X부동산에 관하여 乙을 대리하여 丙과 매매계약을 체결하였고, 丙은 甲이 무권대리인이라는 사실에 대하여 선의ㆍ무과실이었다. 이에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 51,
      topic: "물권법 - 점유 가능한 물권",
      prompt: "토지를 점유할 수 있는 물권을 모두 고른 것은?\nㄱ. 전세권\nㄴ. 지상권\nㄷ. 저당권\nㄹ. 임차권",
      choices: ["ㄱ", "ㄱ, ㄴ", "ㄱ, ㄹ", "ㄷ, ㄹ", "ㄱ, ㄴ, ㄷ"],
      answers: [2],
    },
    {
      number: 52,
    ...
    },
    {
      number: 56,
      topic: "물권법 - 소유권 취득",
      prompt: "소유권의 취득에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 57,
      topic: "물권법 - 공동소유",
      prompt: "민법상 공동소유에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 58,
      topic: "물권법 - 객체",
      prompt: "1필의 토지의 일부를 객체로 할 수 없는 권리는?(다툼이 있으면 판례에 따름)",
      choices: ["저당권", "전세권", "지상권", "임차권", "점유권"],
      answers: [1],
    },
    {
      number: 59,
      topic: "물권법 - 근저당권",
      prompt: "2019. 8. 1. 甲은 乙에게 2억 원(대여기간 1년, 이자 월 1.5 %)을 대여하면서 乙 소유 X토지(가액 3억 원)에 근저당권(채권최고액 2억 5천만 원)을 취득하였고, 2020. 7. 1. 丙은 乙에게 1억 원(대여기간 1년, 이자 월 1 %)을 대여하면서 X토지에 2번 근저당권(채권최고액 1억 5천만 원)을 취득하였다. 甲과 丙이 변제를 받지 못한 상황에서 丙이 2022. 6. 1. X토지에 관해 근저당권 실행을 위한 경매를 신청하면서 배당을 요구한 경우, 이에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)\nㄱ. 2022. 6. 1. 甲의 근저당권의 피담보채권액은 확정되지 않는다.\nㄴ. 甲에게 2022. 6. 1. 이후에 발생한 지연이자는 채권최고액의 범위 내라도 근저당권에 의해 담보되지 않는다.\nㄷ. 甲이 한 번도 이자를 받은 바 없고 X토지가 3억 원에 경매되었다면 甲은 경매대가에서 3억 원을 변제받는다.",
    ...
    },
    {
      number: 63,
      topic: "물권법 - 지역권",
      prompt: "지역권에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 64,
      topic: "물권법 - 토지전세권",
      prompt: "토지전세권에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      ...
      prompt: "제3자를 위한 유상ㆍ쌍무계약에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 70,
      topic: "계약법 - 매매의 일방예약",
      prompt: "甲은 그 소유의 X부동산에 관하여 乙과 매매의 일방예약을 체결하면서 예약완결권은 乙이 가지고 20년 내에 행사하기로 약정하였다. 이에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 72,
      topic: "계약법 - 환매",
      prompt: "부동산의 환매에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 73,
      topic: "계약법 - 토지임대차",
      prompt: "토지임차인에게 인정될 수 있는 권리가 아닌 것은?",
      choices: [
        "부속물매수청구권",
        "유익비상환청구권",
        "지상물매수청구권",
    ...
    },
    {
      number: 78,
      topic: "민사특별법 - 가등기담보",
      prompt: "가등기담보 등에 관한 법률이 적용되는 가등기담보에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 79,
      topic: "민사특별법 - 명의신탁",
      prompt: "2022. 8. 16. 甲은 조세포탈의 목적으로 친구인 乙과 명의신탁약정을 맺고 乙은 이에 따라 甲으로부터 매수자금을 받아 丙 소유의 X토지를 자신의 명의로 매수하여 등기를 이전받았다. 이에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
        "甲과 乙의 명의신탁약정은 무효이다.",
    ...
    },
    {
      number: 80,
      topic: "민사특별법 - 집합건물 관리",
      prompt: "집합건물의 소유 및 관리에 관한 법령상 관리인 및 관리위원회 등에 관한 설명으로 옳은 것은?",
      choices: [
