window.CIVIL_LAW_2024 = {
  id: "realtor-2024-35-a-civil-law",
  title: "2024년 제35회 민법 및 민사특별법",
  ...
  source: {
    question: "https://www.q-net.or.kr/cst003.do?artlSeq=5214724&boardId=Q004&gId=08&gSite=L&id=cst00302&menuType=cst00309",
    answer: "https://www.q-net.or.kr/cst003.do?artlSeq=5218527&boardId=Q004&gId=08&gSite=L&id=cst00302&menuType=cst00310",
  },
  questions: [
    {
      number: 41,
      topic: "법률행위 - 반사회질서",
      prompt: "반사회질서의 법률행위에 해당하는 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 42,
      topic: "법률행위 - 통정허위표시",
      prompt: "甲은 강제집행을 피하기 위해 자신의 X부동산을 乙에게 가장매도하여 소유권이전등기를 해 주었는데, 乙이 이를 丙에게 매도하고 소유권이전등기를 해 주었다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
        "甲과 乙사이의 계약은 무효이다.",
    ...
    },
    {
      number: 46,
      topic: "법률행위 - 의사표시",
      prompt: "甲의 乙에 대한 의사표시에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 47,
      topic: "대리 - 무권대리",
      prompt: "계약의 무권대리에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 52,
      topic: "물권법 - 물권변동",
      prompt: "등기 없이도 부동산 물권취득의 효력이 있는 경우를 모두 고른 것은?(다툼이 있으면 판례에 따름)\nㄱ. 매매\nㄴ. 건물신축\nㄷ. 점유시효취득\nㄹ. 공유물의 현물분할판결",
      choices: ["ㄱ, ㄴ", "ㄴ, ㄷ", "ㄴ, ㄹ", "ㄷ, ㄹ", "ㄱ, ㄷ, ㄹ"],
      answers: [3],
    },
    {
      number: 53,
      topic: "물권법 - 점유권",
      prompt: "점유보호청구권에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 54,
      topic: "물권법 - 등기청구권",
      prompt: "甲은 자신의 토지를 乙에게 매도하여 인도하였고, 乙은 그 토지를 점유․사용하다가 다시 丙에게 매도하여 인도하였다. 甲과 乙은 모두 대금 전부를 수령하였고, 甲ㆍ乙ㆍ丙 사이에 중간생략등기의 합의가 있었다. 다음 설명 중 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 55,
      topic: "물권법 - 공유",
      prompt: "부동산 공유에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 66,
      topic: "계약법 - 계약의 성립",
      prompt: "계약의 성립과 내용에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 68,
      topic: "계약법 - 동시이행의 항변권",
      prompt: "동시이행의 항변권에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      ...
      prompt: "매도인 甲과 매수인 乙사이에 매매대금을 丙에게 지급하기로 하는 제3자를 위한 계약을 체결하였고, 丙이 乙에게 수익의 의사표시를 하였다. 다음 설명 중 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 71,
      topic: "계약법 - 해제",
      prompt: "매도인 甲과 매수인 乙사이의 X주택에 관한 계약이 적법하게 해제된 경우, 해제 전에 이해관계를 맺은 자로서 ‘계약해제로부터 보호되는 제3자’에 해당하지 않는 자는?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 72,
      topic: "계약법 - 해제",
      prompt: "乙은 甲소유 X토지를 매수하고 계약금을 지급한 후 X토지를 인도받아 사용․수익하고 있다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 73,
      topic: "계약법 - 임대차",
      prompt: "건물소유를 목적으로 하는 토지임차인의 지상물매수청구권에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      ...
      prompt: "甲은 자신의 X주택을 보증금 2억원, 월차임 50만원으로 乙에게 임대하였는데, 乙이 전입신고 후 X주택을 점유․사용하면서 차임을 연체하다가 계약이 종료되었다. 계약 종료 전에 X주택의 소유권이 매매를 원인으로 丙에게 이전되었다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 75,
      topic: "민사특별법 - 주택임대차보호법",
      prompt: "임차인 乙은 임대인 甲에게 2024. 3. 10.로 기간이 만료되는 X주택의 임대차계약에 대해 주택임대차보호법에 따라 갱신요구 통지를 하여 그 통지가 2024. 1. 5. 甲에게 도달하였고, 甲이 갱신거절 통지를 하지 않아 계약이 갱신되었다. 그 후 乙이 갱신된 계약기간이 개시되기 전인 2024. 1. 29. 갱신된 임대차계약의 해지를 통지하여 2024. 1. 30. 甲에게 도달하였다. 임대차계약의 종료일은?(다툼이 있으면 판례에 따름)",
      choices: [
        "2024. 1. 30.",
        "2024. 3. 10.",
        "2024. 4. 30.",
    ...
    },
    {
      number: 76,
      topic: "민사특별법 - 집합건물법",
      prompt: "집합건물의 소유 및 관리에 관한 법률상 관리인에 관한 설명으로 틀린 것은?",
      choices: [
        "관리인은 구분소유자여야 한다.",
    ...
    },
    {
      number: 77,
      topic: "민사특별법 - 가등기담보법",
      prompt: "甲은 乙에게 무이자로 빌려준 1억원을 담보하기 위해, 丙명의의 저당권(피담보채권 5,000만원)이 설정된 乙소유의 X건물(시가 2억원)에 관하여 담보가등기를 마쳤고, 乙은 변제기가 도래한 甲에 대한 차용금을 지급하지 않고 있다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 78,
      topic: "민사특별법 - 부동산실명법",
      prompt: "甲은 친구 乙과의 명의신탁약정에 따라 2024. 3. 5. 자신의 X부동산을 乙명의로 소유권이전등기를 해 주었고, 그 후 乙은 丙에게 이를 매도하고 丙명의로 소유권이전등기를 해 주었다. 다음 설명 중 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      ...
      prompt: "임차인 乙은 甲소유의 X상가건물에 관하여 월차임 200만원, 기간 2023. 5. 24. ～ 2024. 5. 23.로 하는 임대차계약을 甲과 체결하였고, 기간만료 14일 전인 2024. 5. 9. 갱신거절의 통지를 하여 다음날 甲에게 도달하였다. 임대차계약의 종료일은?(다툼이 있으면 판례에 따름)",
      choices: [
        "2024. 5. 10.",
        "2024. 5. 23.",
        "2024. 8. 23.",
    ...
    },
    {
      number: 80,
      topic: "민사특별법 - 상가건물 임대차보호법",
      prompt: "상가건물임대차보호법이 적용되는 X건물에 관하여 임대인 甲과 임차인 乙이 보증금 3억원, 월차임 60만원으로 정하여 체결한 임대차가 기간만료로 종료되었다. 그런데 甲이 乙에게 보증금을 반환하지 않아서 乙이 현재 X건물을 점유ㆍ사용하고 있다. 다음 설명 중 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
