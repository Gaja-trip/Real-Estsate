window.CIVIL_LAW_2019 = {
  id: "realtor-2019-30-a-civil-law",
  title: "2019년 제30회 민법 및 민사특별법",
  ...
  source: {
    question: "https://www.q-net.or.kr/cst003.do?artlSeq=5206273&boardId=Q004&gId=08&gSite=L&id=cst00302&menuType=cst00309",
    answer: "https://www.q-net.or.kr/cst003.do?artlSeq=5206494&boardId=Q004&gId=08&gSite=L&id=cst00302&menuType=cst00310",
  },
  questions: [
    {
      number: 41,
    ...
    },
    {
      number: 42,
      topic: "의사표시 - 통정허위표시",
      prompt: "통정허위표시에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 43,
      topic: "법률행위 - 조건과 기한",
      prompt: "조건과 기한에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 44,
      topic: "의사표시 - 도달",
      prompt: "甲은 乙과 체결한 매매계약에 대한 적법한 해제의 의사표시를 내용증명우편을 통하여 乙에게 발송하였다. 다음 설명 중 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 45,
      topic: "대리 - 대리권",
      prompt: "甲은 자신의 X토지를 매도하기 위하여 乙에게 대리권을 수여하였다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 46,
      topic: "대리 - 복대리",
      prompt: "복대리에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
        "복대리인은 본인의 대리인이다.",
    ...
    },
    {
      number: 47,
      topic: "대리 - 무권대리",
      prompt: "대리권 없는 乙이 甲을 대리하여 甲의 토지에 대한 임대차계약을 丙과 체결하였다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 49,
      topic: "법률행위 - 법정추인",
      prompt: "법정추인이 인정되는 경우가 아닌 것은?(단, 취소권자는 추인할 수 있는 상태이며, 행위자가 취소할 수 있는 법률행위에 관하여 이의보류 없이 한 행위임을 전제함)",
      choices: [
    ...
    },
    {
      number: 50,
      topic: "법률행위 - 토지거래허가",
      prompt: "甲은 토지거래허가구역 내에 있는 그 소유 X토지에 관하여 乙과 매매계약을 체결하였다. 비록 이 계약이 토지거래허가를 받지는 않았으나 확정적으로 무효가 아닌 경우, 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 52,
      topic: "물권 - 물권변동",
      prompt: "부동산 물권변동에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 54,
      topic: "물권 - 간접점유",
      prompt: "간접점유에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 55,
      topic: "물권 - 점유취득시효",
      prompt: "점유취득시효에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 56,
      topic: "물권 - 등기청구권",
      prompt: "등기청구권에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 57,
      topic: "물권 - 부합",
      prompt: "부합에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 58,
      topic: "물권 - 공유",
      prompt: "공유에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 59,
      topic: "물권 - 담보지상권",
      prompt: "甲은 乙은행에 대한 채무의 이행을 담보하고자 그 소유 토지(X)에 乙명의의 저당권과 함께 X의 담보가치 유지만을 위한 乙명의의 지상권을 설정하였다. 이후 甲과 丙은 X에 건축물(Y)을 축조하였다. 다음 설명 중 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 61,
      topic: "물권 - 전세권",
      prompt: "甲은 그 소유 X건물의 일부에 관하여 乙명의의 전세권을 설정하였다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 62,
      topic: "물권 - 유치권",
      prompt: "X물건에 대한 甲의 유치권 성립에 영향을 미치지 않는 것은?(다툼이 있으면 판례에 따름)",
      choices: [
        "X의 소유권자가 甲인지 여부",
    ...
    },
    {
      number: 63,
      topic: "물권 - 저당권",
      prompt: "甲은 그 소유 나대지(X)에 乙에 대한 채무담보를 위해 乙명의의 저당권을 설정하였다. 이후 丙은 X에 건물(Y)을 신축하여 소유하고자 甲으로부터 X를 임차하여 Y를 완성한 후, Y에 丁명의의 저당권을 설정하였다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 66,
      topic: "계약 - 제3자를 위한 계약",
      prompt: "甲(요약자)과 乙(낙약자)은 丙을 수익자로 하는 제3자를 위한 계약을 체결하였다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 68,
      topic: "계약 - 합의해제",
      prompt: "합의해제ㆍ해지에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 69,
      topic: "계약 - 매매",
      prompt: "매매계약에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
        "매매계약은 요물계약이다.",
        "매매계약은 유상ㆍ쌍무계약이다.",
        "매도인의 담보책임은 무과실책임이다.",
    ...
    },
    {
      number: 70,
      topic: "계약 - 매매 효력",
      prompt: "甲은 그 소유의 X토지에 대하여 乙과 매매계약을 체결하였다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 71,
      topic: "계약 - 위험부담",
      prompt: "위험부담에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 72,
      topic: "계약 - 환매",
      prompt: "부동산매매에서 환매특약을 한 경우에 관한 설명으로 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 73,
      topic: "계약 - 전세권과 임차권",
      prompt: "건물전세권자와 건물임차권자 모두에게 인정될 수 있는 권리를 모두 고른 것은?\nㄱ. 유익비상환청구권\nㄴ. 부속물매수청구권\nㄷ. 전세금 또는 차임의 증감청구권",
      choices: ["ㄷ", "ㄱ, ㄴ", "ㄱ, ㄷ", "ㄴ, ㄷ", "ㄱ, ㄴ, ㄷ"],
      answers: [5],
    },
    {
      number: 74,
      topic: "계약 - 지상물매수청구권",
      prompt: "임차인 甲이 임대인 乙에게 지상물매수청구권을 행사하는 경우에 관한 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 76,
      topic: "민사특별법 - 주택임대차",
      prompt: "甲이 그 소유의 X주택에 거주하려는 乙과 존속기간 1년의 임대차계약을 체결한 경우에 관한 설명으로 틀린 것은?",
      choices: [
    ...
    },
    {
      number: 77,
      topic: "민사특별법 - 상가임대차",
      prompt: "상가건물 임대차보호법에 관한 설명으로 옳은 것은?",
      choices: [
    ...
    },
    {
      number: 78,
      topic: "민사특별법 - 가등기담보",
      prompt: "가등기담보 등에 관한 법률의 설명으로 옳은 것은?(다툼이 있으면 판례에 따름)",
      choices: [
    ...
    },
    {
      number: 79,
      topic: "민사특별법 - 집합건물",
      prompt: "집합건물의 소유 및 관리에 관한 법률의 설명으로 틀린 것은?",
      choices: [
    ...
    },
    {
      number: 80,
      topic: "민사특별법 - 명의신탁",
      prompt: "X부동산을 매수하고자 하는 甲은 乙과 명의신탁약정을 하고 乙명의로 소유권이전등기를 하기로 하였다. 그 후 甲은 丙에게서 그 소유의 X부동산을 매수하고 대금을 지급하였으며, 丙은 甲의 부탁에 따라 乙 앞으로 이전등기를 해 주었다. 다음 설명 중 틀린 것은?(다툼이 있으면 판례에 따름)",
      choices: [
